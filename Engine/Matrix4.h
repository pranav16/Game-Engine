...
namespace Engine
{
	...
	public:
		...
		Vector TransformPointRV(const Vector & i_Point) const;
		Vector TransformPointCV(const Vector & i_Point) const;

		Vector TransformNormalRV(const Vector & i_Normal) const;
		Vector TransformNormalCV(const Vector & i_Normal) const;
		...
		inline static Matrix4 CreateTranslationRV(const Vector & i_trans);
		...
		inline static Matrix4 CreateTranslationCV(const Vector & i_trans);
